...
ALTER INDEX idx_ShipmentDetailsCS ON dbo.ShipmentDetailsColumnStore REBUILD;
GO
--Reorganize columnstore indexes
ALTER INDEX idx_ShipmentDetailsCS ON dbo.ShipmentDetailsColumnStore REORGANIZE;
GO