...
public class OldCsvProductTarget : IProductTarget
{
    ...
    public OldCsvProductTarget(IOptions<CsvProductTargetOptions> csvProductTargetOptions, IProductFormatter productFormatter, IWriteImportStatistics importStatistics)
    {
