...
namespace ProductImporter.Logic.Test
{
    public class ProductImporterTest
    {
        ...
        public ProductImporterTest()
        {
            ...
            var lazyProductTransformer = new Lazy<IProductTransformer>(() =>
            {
                return _productTransformer.Object;
            });

            _subjectUnderTest = new ProductImporter(_productSource.Object, lazyProductTransformer, _productTarget.Object, _importStatistics.Object);
        }
